          ...
          <div className="py-20 lg:py-25">
            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0 ">
              ...
              >
                ...
                Soiled is a world-class web and mobile solutions for forward-thinking entrepreneur and enterprises. Also, we are one of the world biggest WordPress agency.
                </p>
