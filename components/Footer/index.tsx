    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        ...
        <div className="newsletter">
          ...
          >
            <h4 className="newsletter-text mb-9 text-itemtitle2 font-medium text-black dark:text-white">
              Newsletter
            </h4>
            <p className="newsletter-text mb-4 w-[90%]">
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            ...
            <div className="flex flex-wrap gap-2 lg:justify-between lg:gap-0 ">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="#"
                        className="mb-3 inline-block hover:text-primary mb-1.5 text-sectiontitle uppercase tracking-[5px]"
                      >
                        Contact us
                      </a>  
                  ...
                  <ul>
                    <li>
                      <a
                        ...
                        className="mb-3 inline-block hover:text-primary"
                      >
                        Website Development(UI & UX Web Design)
                      </a>
                    </li>
                    <li>
                      <a
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              ...
              transition={{ duration: 1, delay: 0.1 }}
              viewport={{ once: true }}
              className="animate_top lg:m-auto"
            >
              <ul className="flex items-center gap-8">
                <li>
                  <a href="#" className="hover:text-primary">
                  <b>  Privacy & Terms Policy for Glesyde </b>
                  </a>
                </li>
              </ul>
            </motion.div>
            ...
            <Typewriter/>
              ...
              <div className="flex justify-center w-fit m-auto p-1.5">
