    ...
    <>
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `Passionate individuals with one vision, Remotely Maintain Your Software Application, From Anywhere, Anytime.`,
              subtitle: ``,
              description: `We are Passionate individuals and a strong team! with one vision, an international and globally operating team of experts and Computer Software specialists. Although we rarely see each other in person, we work closely together. We live by honesty and openness, every opinion is desired, valued, and respected. We grow together through mutual exchange.`,
            }}
          />
